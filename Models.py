...
class Matches(Base):
    ...
    def getJson(self):
        match_json = '{"id":"' + str(self.id) + '", "date":"' + str(self.date) + '", "player1":"' + str(
            self.player1) + '", "player2":"' + str(self.player2) + '", "winner":"' + str(self.winner) + '"}'
        print(match_json)
...
class Players(Base):
    ...
    def getJson(self):
        player_json = '{"id":"' + str(self.id) + '", "firstname":"' + str(self.firstname) + '", "lastname":"' + str(
            self.lastname) + '"}'
